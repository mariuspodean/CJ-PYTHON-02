...
class TestIntellectual(unittest.TestCase):
    ...
    def test_Intellectual_object_attribute_initialization(self):
        ...
        test_intellectual = Intellectual(name, dict_of_activities, field_of_interest)
        
        assert hasattr(test_intellectual, 'name'), 'Intellectual object missing name attribute'
        assert hasattr(test_intellectual, 'dict_of_activities'), 'Intellectual object missing dict_of_activities attribute'
        assert hasattr(test_intellectual, 'field_of_interest'), 'Intellectual object missing field_of_interest attribute'
...
class TestDomainsCollection(unittest.TestCase):
    ...
    def test_DomainsCollection_object_attribute_initialization(self):
        ...
        name = 'test'
        domains_collection = ('Social', 'Emotional', 'Intellectual', 'Physical', 'Spiritual')
        
        test_DomainsCollection = DomainsCollection(name, domains_collection)
        
        assert hasattr(test_DomainsCollection, 'name'), 'DomainsCollection object missing name attribute'
        assert hasattr(test_DomainsCollection, 'domains_collection'), 'DomainsCollection object missing domains_collection attribute'
...
class TestEmotional(unittest.TestCase):
    ...
    def test_lt_operator_overloading(self):
        ...
        dict_of_activities_desired = {'recognizing emotions in self':1, 'managing self-emotions':1}
        dict_of_activities_actual = {'recognizing emotions in self':3, 'managing self-emotions':1, 'managing relationships':4}
        EQ_desired = 120
        EQ_actual = 120
        
        test_desired = Emotional(name_desired, dict_of_activities_desired, EQ_desired)
        test_actual = Emotional(name_actual, dict_of_activities_actual, EQ_actual)
...
class Test_Check_Status(unittest.TestCase):
    ...
    def test_check_status_returns_list(self):
        ...
        Ale_DSo = Social('Desired Social', {'monthly_message': 4, 'monthly_meeting': 1, 'randomly_calls': 2}, {})
        ...
        Ale_ASo = Social('Actual Social',{'monthly_message': 6, 'monthly_meeting': 3, 'randomly_calls': 2} , {})
        ...
        assert type(check_status(Ale_DCollection, Ale_ACollection) == list), 'Check-status does not return a list'
