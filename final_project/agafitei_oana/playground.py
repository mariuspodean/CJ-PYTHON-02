...
Christmas_Spirit_Bouquet = Bouquet("Christmas Spirit Bouquet",
                                   Christmas_Spirit_Bouquet_flowers)

Smiles_Sunshine_Bouquet_flowers = {'Peruvian Lily': 7, 'Rose': 9}

Smiles_Sunshine_Bouquet = Bouquet("Smiles & Sunshine Bouquet",
...
Christmas_Celebration_Bouquet = Bouquet("Christmas Celebration Bouquet",
                                        Christmas_Celebration_Bouquet_flowers)
...
White_Medley_Bouquet = Bouquet("White Medley Bouquet",
                               White_Medley_Bouquet_flowers)
...
Rainbow_Alstroemeria_Bouquet = Bouquet("Rainbow Alstroemeria_Bouquet",
                                       Rainbow_Alstroemeria_Bouquet_flowers)
Christmas_Spirit_Bouquet = PrettyBouquet("Christmas Spirit Bouquet",
                                         Christmas_Spirit_Bouquet_flowers)

stock = [
    Christmas_Spirit_Bouquet, Smiles_Sunshine_Bouquet,
    Christmas_Celebration_Bouquet, White_Medley_Bouquet,
